...
(b+='<p class="interact"><a href="https://twitter.com/intent/tweet?in_reply_to='+p[d]+'" class="twitter_reply_icon"'+(u?' rel="external">':">")+'Reply</a><a href="https://twitter.com/intent/retweet?tweet_id='+p[d]+'" class="twitter_retweet_icon"'+(u?' rel="external">':">")+'Retweet</a><a href="https://twitter.com/intent/favorite?tweet_id='+p[d]+'" class="twitter_fav_icon"'+(u?' rel="external">':">")+"Favorite</a></p>");I&&void 0!==h[d]&&(b+='<div class="media"><img src="'+E(h[d])+'" alt="Image from tweet" /></div>');
