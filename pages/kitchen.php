<section class="row margtop">
	<div class="large-12 columns">
		<article class="docs-component" id="docs-kitchen-sink">
			...
			<p class="lead docs-page-lead"><a href="http://foundation.zurb.com/sites/docs/kitchen-sink.html" title="" rel="external">Everything but.</a></p>
			<hr>
			<div class="row">
				<div class="large-12 columns" id="docs">
					<h2 id="abide class="docs-heading" data-magellan-target="abide"><a class="docs-heading-icon" href="#abide"></a>Abide</h2>
					...
					<hr>				
					<h2 id="accordion" class="docs-heading" data-magellan-target="accordion"><a class="docs-heading-icon" href="#accordion"></a>Accordion</h2>
					<div class="docs-code-live">
					...
					<hr>
					<h2 class="docs-heading" data-magellan-target="float-class"><a class="docs-heading-icon" href="#float-class"></a>Float Classes</h2>
					<div class="docs-code-live">
					...
					<!--hr>
					<h2 id="grid" class="docs-heading" data-magellan-target="grid"><a class="docs-heading-icon" href="#grid"></a>Grid</h2>
					<div class="docs-code-live">
						<div class="row">
					...
					<div class="docs-code-live">
						<div class="media-object">
							<div class="media-object-section">
								<img src= "assets/images/200x200.gif" alt="">
							</div>
							<div class="media-object-section">
					...
					<div class="docs-code-live">
						...
						<ul class="menu icon-top">
							<li><a href="#"><i class="fa fa-bars"></i> <span>One</span></a></li>
							<li><a href="#"><i class="fa fa-bars"></i> <span>Two</span></a></li>
							<li><a href="#"><i class="fa fa-bars"></i> <span>Three</span></a></li>
							<li><a href="#"><i class="fa fa-bars"></i> <span>Four</span></a></li>
						</ul>
						<h6>Vertical</h6>
					...
					<hr>
					<h2 id="progress-bar" class="docs-heading" data-magellan-target="progress-bar"><a class="docs-heading-icon" href="#progress-bar"></a>Pagination</h2>
					...
					<hr>
					<h2 id="sticky" class="docs-heading" data-magellan-target="sticky"><a class="docs-heading-icon" href="#sticky"></a>Sticky</h2>
						<div class="docs-code-live">
							<div class="row">
								...
								<div class="columns small-6 right" data-sticky-container>
									<div class="sticky" data-sticky data-anchor="example1">
										<img class="thumbnail" src="assets/images/350x200.gif">
									</div>
								</div>
							</div>
						</div>
					...
					<hr>
					<h2 id="reveal" class="docs-heading" data-magellan-target="reveal"><a class="docs-heading-icon" href="#reveal"></a>Reveal</h2>
					<p><a class="small button" data-open="exampleModal1">Click me for a modal</a></p>
					...
					<div class="docs-code-live">
						...
						<div class="tabs-content" data-tabs-content="example-tabs">
							...
							<div class="tabs-panel" id="panel2">
								<p>two</p>
								<img class="thumbnail" src="assets/images/150x150.gif">
							</div>
					...
					<div class="docs-code-live">
						<div class="row">
							<div class="small-4 columns">
								<img class="thumbnail" src="assets/images/500x500.gif" alt="">
							</div>
							<div class="small-4 columns">
								<img class="thumbnail" src="assets/images/500x500.gif" alt="">
							</div>
					...
					<hr>
					<h2 id="toggler" class="docs-heading" data-magellan-target="toggler"><a class="docs-heading-icon" href="#toggler"></a>Toggler</h2>
					<div class="docs-code-live">
						<p><a class="small button" data-toggle="menuBar">Expand!</a></p>
					...
					<hr>
					<h2 id="visibility-classes" class="docs-heading" data-magellan-target="visibility-classes"><a class="docs-heading-icon" href="#visibility-classes"></a>Visibility Classes</h2>
					<div class="docs-code-live">
	...
	<div class="row">
		<div class="large-12 columns">
			<p class="text-right"><a rel="external" href="view-source:<?php echo $xoomvc_url;?>">Afficher le code source html de la page</a></p>
		</div>
	</div>
</section>