<style>.fi-social-facebook{color:dodgerblue;font-size:2rem;}.fi-social-youtube{color:red;font-size:2rem;}.fi-social-pinterest{color:darkred;font-size:2rem;}i.fi-social-instagram{color:brown;font-size:2rem;}i.fi-social-tumblr{color:navy;font-size:2rem;}.fi-social-twitter{color:skyblue;font-size:2rem;}span.label{margin-bottom:.5em;} section .submenu {list-style:none;}</style>
<section class="margtop">
	<!--div class="row">
		<div class="medium-4 columns">
			<img src="assets/images/450x183.gif" alt="company logo">
		</div>
		<div class="medium-8 columns">
			<img src="assets/images/900x175.gif" alt="advertisement for deep fried Twinkies">
		</div>
	</div>
	<br-->
	<!--div class="top-bar dark">
		<ul class="menu dropdown expanded text-center" data-dropdown-menu>
	...
	<div class="row">
		<div class="medium-8 columns">
			<p><img src="assets/images/900x450.gif" alt="main article image"></p>
		</div>
		<div class="medium-4 columns">
			<p><img src="assets/images/400x200.gif" alt="article promo image" alt="advertisement for deep fried Twinkies"></p>
			<p><img src="assets/images/400x200.gif" alt="article promo image"></p>
		</div>
	</div>
	<hr>
	...
	<div class="row small-up-3 medium-up-4 large-up-5">
		<div class="column">
			<img src="assets/images/400x370.gif" alt="image for article">
		</div>
		<div class="column">
			<img src="assets/images/400x370.gif" alt="image for article">
		</div>
			...
			<article>
				<div class="row">
					<div class="large-6 columns">
						<p><img src="assets/images/600x370.gif" alt="article preview image"></p>
					</div>
					<div class="large-6 columns">
		...
		<div class="large-4 columns">
			<aside>
				...
				<div class="row column">
					...
					<p><img src="assets/images/400x300.gif" alt="advertisement of ShamWow"></p>
				</div>
				<br>
				<div class="row column">
					...
					<div class="media-object">
						<div class="media-object-section">
							<img class="thumbnail" src="assets/images/100x100.gif">
						</div>
						<div class="media-object-section">
	...
	<div class="row expanded callout secondary">
		<div class="large-4 columns">
			...
			<div class="row small-up-4">
				<div class="column"><img class="thumbnail" src="assets/images/75x75.gif" alt="image of space dog"></div>
				<div class="column"><img class="thumbnail" src="assets/images/75x75.gif" alt="image of space dog"></div>
				<div class="column"><img class="thumbnail" src="assets/images/75x75.gif" alt="image of space dog"></div>
				<div class="column"><img class="thumbnail" src="assets/images/75x75.gif" alt="image of space dog"></div>
				<div class="column"><img class="thumbnail" src="assets/images/75x75.gif" alt="image of space dog"></div>
