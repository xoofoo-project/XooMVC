<section class="margtop">
	...
	<div class="row">
		<div class="medium-6 columns">
			<img class="thumbnail" src="assets/images/650x350.gif">
			<div class="row small-up-4">
				<div class="column">
					<img class="thumbnail" src="assets/images/250x200.gif" alt="thumbs">
				</div>
				<div class="column">
					<img class="thumbnail" src="assets/images/250x200.gif" alt="thumbs">
				</div>
	...
	<div class="column row">
			...
			<div class="tabs-panel is-active" id="panel1">
				...
				<div class="media-object">
					<div class="media-object-section">
						<img class="thumbnail" src="assets/images/200x200.gif" alt="thumbs">
					</div>
					<div class="media-object-section">
		...
		<div class="tabs-panel" id="panel2">
			<div class="row medium-up-3 large-up-5">
				<div class="column">
					<img class="thumbnail" src="assets/images/350x200.gif" alt="thumbs">
